...
import { BsAsterisk, BsImages, BsStarFill } from 'react-icons/bs'
                  ...
                  activeIndex === 3 && (
                    <>
                      <Link href="#overview" className="px-0">
                        <p
                          className={`text-black nav-link rounded-4 p-lg-3 p-sm-2 text-capitalize mb-0 d-flex align-items-center gap-2 p-2 pe-0 ${activeSection === "overview" ? "active" : ""
                            }`}
                        >
                      ...
                      <Link href="#features" className="px-0">
                        <p
                          className={`text-black nav-link rounded-4 p-lg-3 p-sm-2 text-capitalize mb-0 d-flex align-items-center gap-2 p-2 pe-0 ${activeSection === "features" ? "active" : ""
                            }`}
                        >
                          {/* <span className="text-black me-1 fw-bold d-flex justify-content-center align-items-center">
                            <BsAsterisk />
                      ...
                      <Link href="#cab-charges" className="px-0">
                        <p
                          className={`text-black nav-link rounded-4 p-lg-3 p-sm-2 text-capitalize mb-0 d-flex align-items-center gap-2 p-2 pe-0 ${activeSection === "cab-charges" ? "active" : ""
                            }`}
                        >
                          {/* <span className="text-black me-1 fw-bold d-flex justify-content-center align-items-center">
                            <BsAsterisk />
                      ...
                      <Link href="#gallery" className="px-0">
                        <p
                          className={`text-black nav-link rounded-4 p-lg-3 p-sm-2 text-capitalize mb-0 d-flex align-items-center gap-2 p-2 pe-0 ${activeSection === "gallery" ? "active" : ""
                            }`}
                        >
                          {/* <span className="text-black me-1 fw-bold d-flex justify-content-center align-items-center">
                            <BsAsterisk />
