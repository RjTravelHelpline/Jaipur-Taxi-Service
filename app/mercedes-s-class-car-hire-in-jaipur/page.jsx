...
const Page = () => {
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "mercedes s class cab", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/mercedes-s-class-banner.png" />
      {/* breadcrumb */}
        ...
        <div className="container bread-container">
          <div className="row px-lg-2 px-sm-0 bread-row">
            <Breadcrumb>
              ...
              <BreadcrumbItem active>mercedes s class </BreadcrumbItem>
            </Breadcrumb>
          </div>
        </div>
      </div>
