...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "18 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "18 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/18-seater-bus-banner.jpg" />
