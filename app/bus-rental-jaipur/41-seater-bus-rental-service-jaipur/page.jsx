...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Bus Rental Jaipur", link: "/bus-rental-service-in-jaipur", active: false },
    { label: "41 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "41 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/41-seater-bus-banner.jpg" />
