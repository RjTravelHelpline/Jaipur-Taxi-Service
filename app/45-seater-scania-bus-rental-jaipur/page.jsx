...
const Page = () => {
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "toyota etios cab", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/toyota-etios-banner.jpg" />
      {/* breadcrumb */}
        ...
        <div className="container bread-container">
          <div className="row px-lg-2 px-sm-0 bread-row">
            <Breadcrumb>
              ...
              <BreadcrumbItem href="/suv-car-rental-jaipur">Sedan cab rental</BreadcrumbItem>
              <BreadcrumbItem active>Toyota Etios</BreadcrumbItem>
            </Breadcrumb>
          </div>
        </div>
      </div>
