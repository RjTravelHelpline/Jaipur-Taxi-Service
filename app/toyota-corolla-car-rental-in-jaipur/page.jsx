...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Toyota Corolla", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Toyota Corolla", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/toyota-corolla-banner.png" />
