...
const Page = () => {
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "audi cab", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/audi-banner.png" />
      {/* breadcrumb */}
        ...
        <div className="container bread-container">
          <div className="row px-lg-2 px-sm-0 bread-row">
            <Breadcrumb>
              ...
              <BreadcrumbItem active>audi class </BreadcrumbItem>
            </Breadcrumb>
          </div>
        </div>
      </div>
