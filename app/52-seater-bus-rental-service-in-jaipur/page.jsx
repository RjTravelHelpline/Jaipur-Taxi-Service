...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "52 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "52 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/52-seater-bus-banner.jpg" />
