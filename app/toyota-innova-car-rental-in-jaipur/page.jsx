...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "SUV Car Rental Jaipur", link: "/suv-car-rental-jaipur", active: false },
    { label: "Toyota Innova", link: null, active: true }, // 'active' indicates the current page
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "toyota innova cab", subheading: "Travel without breaking the bank" }
        ]}
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider w-100 py-3" id="overview">
                ...
                <p className='w-100 web-title fw-bold'>
                  Toyota Motor Corporation philosophy is a promise that your world is best protected in the Toyota Innova Taxi Cars.
                </p>
                <p className='text-justify'>
                  Car Rental Jaipur offer&apos;s Innova Cab Service for Jaipur Local, Intercity Travel & Outstation Trips from Jaipur, Jodhpur, Udaipur, Jaisalmer, Mount Abu & other cities of Rajasthan. Our Regulary Sanitized Toyota Innova Taxi Cars are driven by medically fit, police verified, experienced & soft spoken taxi drivers. Our Toyota Innova Taxi Car Rental Service is available for Jaipur to Jodhpur, Jaipur to Barmer, Jaipur to Udaipur, Jaipur to Vaishno Devi, Jaipur to Shimla, Jaipur to Manali, Jaipur to Nainital and all over India. Our Car Rental Service is available at lowest cab fare in Jaipur.
                </p>
              </div>
