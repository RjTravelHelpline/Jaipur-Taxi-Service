...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Mahindra Scorpio", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Mahindra Scorpio", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/scorpio-banner.jpg" />
