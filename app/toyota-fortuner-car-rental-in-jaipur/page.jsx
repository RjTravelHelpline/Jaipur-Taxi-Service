...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Toyota Fortuner", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Toyota Fortuner", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/toyota-fortuner-banner.jpg" />
