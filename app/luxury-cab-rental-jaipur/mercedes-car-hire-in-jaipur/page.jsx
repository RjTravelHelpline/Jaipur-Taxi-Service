...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Luxury Cab Rental", link: "/luxury-car-rental-jaipur", active: false },
    { label: "Mercedes Car Hire", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Mercedes Car Hire", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/mercedes-e-class-banner.jpg" />
