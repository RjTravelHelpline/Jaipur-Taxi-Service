...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Mahindra Bolero", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Mahindra Bolero", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/bolero-banner.jpg" />
