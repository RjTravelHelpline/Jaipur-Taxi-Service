...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "TATA Indica", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "TATA Indica", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/tata-indica-banner.jpg" />
