...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "45 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "45 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/45-seater-bus-banner.jpg" />
