...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "35 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "35 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/35-seater-bus-banner.jpg" />
