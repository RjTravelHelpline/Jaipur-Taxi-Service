...
const Page = () => {
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "ford endeavour cab", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/ford-endeavour-banner.png" />
      {/* breadcrumb */}
        ...
        <div className="container bread-container">
          <div className="row px-lg-2 px-sm-0 bread-row">
            <Breadcrumb>
              ...
              <BreadcrumbItem active>ford endeavour </BreadcrumbItem>
            </Breadcrumb>
          </div>
        </div>
      </div>
