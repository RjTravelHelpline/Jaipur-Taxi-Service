...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "27 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "27 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/27-seater-bus-banner.jpg" />
