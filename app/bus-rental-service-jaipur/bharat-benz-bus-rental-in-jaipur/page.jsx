...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Bus Rental Jaipur", link: "/bus-rental-service-jaipur", active: false },
    { label: "Bharat Benz Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Bharat Benz Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="" />
