...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "21 Seater Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "21 Seater Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/21-seater-bus-banner.jpg" />
