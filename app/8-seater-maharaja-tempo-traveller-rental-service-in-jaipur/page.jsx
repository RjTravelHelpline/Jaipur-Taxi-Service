...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "8 Seater Maharaja Tempo Traveller", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "8 Seater Maharaja Tempo Traveller", subheading: "Travel without breaking the bank" }
        ]}
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="8 Seater Maharaja Tempo Traveller"
                />
              </div>
            </div>
