...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Maruti Ciaz", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Maruti Ciaz", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/maruti-ciaz-banner.jpg" />
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="Maruti Ciaz"
                />
              </div>
            </div>

            {/* sticky side content */}
            <div className="col-lg-3 col-sm-12 about-nav bg-white px-1">
              <RentalCategory
