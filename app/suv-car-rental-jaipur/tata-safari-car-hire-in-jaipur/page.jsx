...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "TATA Safari", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "TATA Safari", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/tata-safari-banner.jpg" />
