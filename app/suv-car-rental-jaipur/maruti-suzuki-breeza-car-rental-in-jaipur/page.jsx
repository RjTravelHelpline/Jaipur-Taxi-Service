...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Maruti Suzuki Breeza", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Maruti Suzuki Breeza", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="" />
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="Maruti Suzuki Breeza"
                />
              </div>
            </div>
