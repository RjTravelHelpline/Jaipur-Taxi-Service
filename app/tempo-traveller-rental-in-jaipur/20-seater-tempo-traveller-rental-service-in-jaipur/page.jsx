...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Tempo Traveller Rental", link: "/tempo-traveller-rental-in-jaipur", active: false },
    { label: "20 Seater Tempo Traveller", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "20 Seater Tempo Traveller", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="\Images\Cabs\20-seater-tempo-banner.jpg" />
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="20 Seater Tempo Traveller"
                />
              </div>
            </div>
