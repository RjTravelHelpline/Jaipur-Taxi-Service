...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "15 Seater Tempo Traveller", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "15 Seater Tempo Traveller", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/15-seater-tempo-banner.jpg" />
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="15 Seater Tempo Traveller"
                />
              </div>
            </div>
