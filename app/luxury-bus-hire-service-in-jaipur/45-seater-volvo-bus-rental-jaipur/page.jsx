...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Luxury Bus Rental", link: "/luxury-bus-hire-service-in-jaipur", active: false },
    { label: "45 Seater Volvo Bus", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "45 Seater Volvo Bus", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/45-seater-volvo-bus-banner.jpg" />
            ...
            <div className="col-lg-9 col-sm-12 mb-lg-3 mb-sm-2 d-flex justify-content-center align-items-center flex-column px-lg-3 px-sm-0">
              ...
              <div className="cab-insider bg-black book-now w-100 p-2 rounded-4">
                <BookNow
                  ...
                  buttonText="Book Now"
                  modalTitle="10 Seater Volvo Bus"
                />
              </div>
            </div>
