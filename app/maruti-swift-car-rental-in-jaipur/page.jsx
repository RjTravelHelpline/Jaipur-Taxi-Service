...
const Page = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Maruti Swift", link: null, active: true },
  ];
  ...
  return (
    <>
      ...
      <HeroBanner
        slides={[
          { heading: "Maruti Swift", subheading: "Travel without breaking the bank" }
        ]}
        backgroundImage="/Images/Cabs/swift-banner.jpg" />
